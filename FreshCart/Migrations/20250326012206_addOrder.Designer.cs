...
namespace FreshCart.Migrations
{
    ...
    [Migration("20250326012206_addOrder")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FreshCart.Models.Domain.Cart", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FreshCart.Models.Domain.CartItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FreshCart.Models.Domain.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FreshCart.Models.Domain.OrderItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FreshCart.Models.Domain.CartItem", b =>
                {
                    b.HasOne("FreshCart.Models.Domain.Cart", "Cart")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("FreshCart.Models.Domain.OrderItem", b =>
                {
                    b.HasOne("FreshCart.Models.Domain.Order", "Order")
                        .WithMany("Items")
